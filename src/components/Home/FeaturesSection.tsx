    ...
    <section className="container mx-auto px-6 py-26 md:py-34">
      <div className={'max-w-7xl mx-auto'}>
        <div className={'text-center mb-18'}>
          <h2 className={'text-5xl md:text-6xl font-bold mb-4 text-slate-950 dark:text-slate-100'}>
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <h3
                  className={
                    'text-2xl font-bold mb-3 text-slate-950 dark:text-slate-100 group-hover:text-brand-500 transition-colors'
                  }
                >
                  {feature.title}
                </h3>

        ...
        <div className={'max-w-5xl mx-auto'}>
          <div className={'text-center mb-20 animate-float'}>
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold leading-tight">
              ...
              <span className="text-slate-950 dark:text-slate-100"> Your</span>
              <br />
            ...
            <p
              className={
                'text-xl md:text-2xl text-slate-800 dark:text-slate-200 mb-12 max-w-3xl mx-auto leading-relaxed'
              }
            >

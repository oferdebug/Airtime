...
export default defineSchema({
  projects: defineTable({
    ...
    fileDuration: v.string(), //Original File Duration Displayed
    ...
    jobErrors:v.optional(
      ...
      transcript: v.optional(
          v.object( {
              ...
              chepaters: v.optional(
                  v.array(
                      v.object( {
                          start: v.number(), //Start Time In Miliseconds
                          end: v.number(), //End Time In Miliseconds
      ...
      //Platoform Optimazied Social Media Content Posts
